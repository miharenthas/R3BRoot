...
void create_glad_geo_vac(const char* geoTag)
{
  ...
  geoFileName = geoFileName + geoTag + "_vacuum.geo.root";
  // --------------------------------------------------------------------------
  ...
  FairGeoMedium* mAir      = geoMedia->getMedium("vacuum");
  if ( ! mAir ) Fatal("Main", "FairMedium vacuum not found");
